...
public class ModSounds 
{
	...
	public static final RegistryObject<SoundEvent> KILL_EFFECT_KILL   = register("kill_effect.kill");
	public static final RegistryObject<SoundEvent> KILL_EFFECT_ACE    = register("kill_effect.ace");
	public static final RegistryObject<SoundEvent> KILL_EFFECT_MARIO  = register("kill_effect.mario");
	public static final RegistryObject<SoundEvent> KILL_EFFECT_MEXICO = register("kill_effect.mexico");
	public static final RegistryObject<SoundEvent> KILL_EFFECT_TRASH  = register("kill_effect.trash");

	public static final RegistryObject<SoundEvent> ITEM_GLOCK19_FIRE        = register("item.glock19.fire");
	public static final RegistryObject<SoundEvent> ITEM_GLOCK19_SUPPRESSION = register("item.glock19.suppression");
