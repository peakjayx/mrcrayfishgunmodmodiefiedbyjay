...
import com.mrcrayfish.guns.item.GunSwitchItem;
...
import com.mrcrayfish.guns.item.SideMountItem;
...
public class ModItems
{
    ...
    /* Custom Glock weapons */
    public static final RegistryObject<GunItem> GLOCK19 = REGISTER.register("glock19", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<GunItem> GLOCK19_SWITCH = REGISTER.register("glock19_switch", () -> new SwitchGunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<GunItem> GLOCK19_LARGEMAG = REGISTER.register("glock19_largemag", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<GunItem> GLOCK19_LARGEMAG_SWITCH = REGISTER.register("glock19_largemag_switch", () -> new SwitchGunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> GUN_SWITCH = REGISTER.register("gun_switch", () -> new GunSwitchItem(new Item.Properties().tab(GunMod.GROUP)));
    public static final RegistryObject<Item> MAGAZIN = REGISTER.register("magazin", () -> new Item(new Item.Properties().stacksTo(16).tab(GunMod.GROUP)));
    // Helm, Westen, Shield → MetropoliaMod (metropoliamod:gear)
    ...
    public static final RegistryObject<Item> FLASHLIGHT = REGISTER.register("flashlight", () -> new SideMountItem(SideMount.create(GunModifiers.LIGHT_RECOIL), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> RED_DOT = REGISTER.register("red_dot", () -> new SideMountItem(SideMount.create(GunModifiers.REDUCED_RECOIL), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
}
