...
public class AttachmentSlot extends Slot
{
    ...
    public boolean mayPlace(ItemStack stack)
    {
        ...
        GunItem item = (GunItem) this.weapon.getItem();
        Gun modifiedGun = item.getModifiedGun(this.weapon);
        if(stack.getItem() instanceof ISideMount)
        {
            return (this.type == IAttachment.Type.SIDE_LEFT
                || this.type == IAttachment.Type.SIDE_RIGHT
                || this.type == IAttachment.Type.UNDER_BARREL)
