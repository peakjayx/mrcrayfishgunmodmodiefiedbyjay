...
public final class Gun implements INBTSerializable<CompoundNBT>
{
    ...
    public static class Modules implements INBTSerializable<CompoundNBT>
    {
        ...
        public static class Attachments implements INBTSerializable<CompoundNBT>
        {
            ...
            @Optional
            @Nullable
            private ScaledPositioned sideLeft;
            @Optional
            @Nullable
            private ScaledPositioned sideRight;
            ...
            @Nullable
            public ScaledPositioned getSideLeft()
            {
                return this.sideLeft;
            }

            @Nullable
            public ScaledPositioned getSideRight()
            {
            ...
            public CompoundNBT serializeNBT()
            {
                ...
                {
                    tag.put("SideLeft", this.sideLeft.serializeNBT());
                }
                if(this.sideRight != null)
                {
                    tag.put("SideRight", this.sideRight.serializeNBT());
                }
                return tag;
            }
            ...
            public void deserializeNBT(CompoundNBT tag)
            {
                ...
                if(tag.contains("SideLeft", Constants.NBT.TAG_COMPOUND))
                {
                    this.sideLeft = this.createScaledPositioned(tag, "SideLeft");
                }
                if(tag.contains("SideRight", Constants.NBT.TAG_COMPOUND))
                {
                    this.sideRight = this.createScaledPositioned(tag, "SideRight");
                }
            }
            ...
            public JsonObject toJsonObject()
            {
                ...
                if(this.sideLeft != null)
                {
                    object.add("sideLeft", this.sideLeft.toJsonObject());
                }
                if(this.sideRight != null)
                {
                    object.add("sideRight", this.sideRight.toJsonObject());
                }
                return object;
            }
            ...
            public Attachments copy()
            {
                ...
                if(this.sideLeft != null)
                {
                    attachments.sideLeft = this.sideLeft.copy();
                }
                if(this.sideRight != null)
                {
                    attachments.sideRight = this.sideRight.copy();
                }
                return attachments;
            }
    ...
    public boolean canAttachType(@Nullable IAttachment.Type type)
    {
        if(this.modules.attachments != null && type != null)
        {
            switch(type)
            {
                ...
                case SIDE_LEFT:
                    return this.modules.attachments.sideLeft != null;
                case SIDE_RIGHT:
                    return this.modules.attachments.sideRight != null;
            }
        }
        return false;
    }
    ...
    public ScaledPositioned getAttachmentPosition(IAttachment.Type type)
    {
        if(this.modules.attachments != null)
        {
            switch(type)
            {
                ...
                case SIDE_LEFT:
                    return this.modules.attachments.sideLeft;
                case SIDE_RIGHT:
                    return this.modules.attachments.sideRight;
            }
        }
        return null;
    }
