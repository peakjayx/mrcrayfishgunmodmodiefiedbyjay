...
public enum SpecialModels
{
    ...
    // Helm-Varianten – via addSpecialModel für Overrides vorgeladen
    SWAT_HELM_NV(       new ResourceLocation(Reference.MOD_ID, "item/swat_helm_nv"),        true),
    SWAT_HELM_VISIER(   new ResourceLocation(Reference.MOD_ID, "item/swat_helm_visier"),    true),
    SWAT_HELM_NV_VISIER(new ResourceLocation(Reference.MOD_ID, "item/swat_helm_nv_visier"), true);
