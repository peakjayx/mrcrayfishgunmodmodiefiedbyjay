...
public class PacketHandler
{
    ...
    public static void init()
    {
        ...
        registerPlayMessage(MessageSyncVest.class,    MessageSyncVest::new,    LogicalSide.CLIENT);
        registerPlayMessage(MessageToggleHelm.class,  MessageToggleHelm::new,  LogicalSide.SERVER);
        registerPlayMessage(MessageToggleLight.class, MessageToggleLight::new, LogicalSide.SERVER);
    }
