...
public class GunGen extends GunProvider
{
    ...
    protected void registerGuns()
    {
        ...
        this.addGun(new ResourceLocation(Reference.MOD_ID, "glock19"), Gun.Builder.create()
                .setFireRate(4)
                .setGripType(GripType.ONE_HANDED)
                .setMaxAmmo(15)
                .setReloadAmount(15)
        ...
        this.addGun(new ResourceLocation(Reference.MOD_ID, "glock19_switch"), Gun.Builder.create()
                .setFireRate(4)
                .setGripType(GripType.ONE_HANDED)
                .setMaxAmmo(15)
                .setReloadAmount(15)
